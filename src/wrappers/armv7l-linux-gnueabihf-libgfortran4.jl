# Autogenerated wrapper script for MPItrampoline_jll for armv7l-linux-gnueabihf-libgfortran4
...
JLLWrappers.@declare_library_product(libmpi, "libmpi.so.2.8.0")
JLLWrappers.@declare_library_product(libmpifort, "libmpifort.so.2.8.0")
